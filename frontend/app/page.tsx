    ...
    <div className="flex flex-col gap-10">
      <section className="flex flex-col gap-4">
        ...
        <p className="max-w-2xl text-lg text-ink/70">
          ...
          the African diaspora, settled on Arbitrum. Your funds sit in a contract you control. An off-chain agent can
          only ever act within limits you set, and you can revoke it instantly.
        </p>
      </section>
      ...
      <section className="grid gap-6 sm:grid-cols-2">
        ...
        <div className="card flex flex-col gap-3">
          ...
          <p className="text-sm text-ink/70">
            ...
            top up a vault — useful for a family member funding someone else's goal.
          </p>
      ...
      <section className="card">
        ...
        <p className="text-sm text-ink/70">
          ...
          Every action it takes is tagged with the live gas price at execution time, so its timing claims can be
          checked on the explorer, not just trusted.
        </p>
      </section>
    </div>
  );
